...
// Mock product database with country availability
const mockProducts = [
  {
    id: 1,
    type: "product",
    ...
    availableCountries: ["us", "ca", "uk", "de", "fr", "jp", "au"],
    originCountry: "us",
  },
  {
    id: 2,
    ...
    availableCountries: ["us", "ca", "uk", "de", "fr", "jp", "au", "kr"],
    originCountry: "jp",
  },
  {
    id: 3,
    ...
    availableCountries: ["us", "ca", "uk", "de", "fr", "au"],
    originCountry: "us",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    availableCountries: ["us", "ca", "uk", "de", "fr"],
    originCountry: "ca",
  },
  {
    id: 7,
  ...
  },
  {
    ...
    description: "Enhanced Nintendo Switch with vibrant OLED screen and improved audio for handheld gaming.",
    price: 349.99,
    ...
    discount: 0,
    keywords: ["gaming", "nintendo", "switch", "console", "oled", "handheld"],
    availableCountries: ["us", "ca", "uk", "de", "fr", "jp", "au"],
    originCountry: "jp",
  },
  {
    ...
    description: "Premium wireless earbuds with world-class noise cancellation and superior sound quality.",
    price: 279.99,
    ...
    discount: 15,
    keywords: ["earbuds", "wireless", "bose", "noise canceling", "audio", "premium"],
    availableCountries: ["us", "ca", "uk", "de", "fr", "au"],
    originCountry: "us",
  },
]
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (country !== "all") {
      filteredProducts = filteredProducts.filter((product) =>
        product.availableCountries?.includes(country.toLowerCase()),
      )
    }
